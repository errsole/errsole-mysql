...
class ErrsoleMySQL extends EventEmitter {
  /**
   * Constructs an instance of the database handler using mysql2.
   * This constructor initializes a connection pool with the mysql2 library and sets basic configuration.
   * @param {Object} options - Configuration options for the mysql2 connection pool,
   * including host, user, password, and database as needed for establishing a connection.
   */
  constructor (options = {}) {
    super();
